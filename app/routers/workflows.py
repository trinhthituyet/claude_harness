    ...
    return [
        {
            ...
            "nodes": [
                ...
                # Each role is handed only the review notes addressed to it.
                ...
                {"key": "review", "role": "Software Architect",
                 ...
                 # The example graph's ReviewResult, as a schema.
                 "output_schema": {
                     "type": "object",
                     "properties": {
                ...
                {"key": "pm", "role": "Tester", "output_key": "pm_report", "max_visits": 3,
                 ...
                 "output_schema": {
                     ...
                     "properties": {
                         ...
                         "failure_type": {
                             "type": "string",
                             "enum": ["none", "code_bug", "arch_issue", "design_issue",
                                      "test_issue"],
                         },
                         "feedback": {"type": "string"},
                     },
                     "required": ["failure_type", "feedback"],
                     "additionalProperties": False,
                 }},
            ...
            "edges": [
                ...
                # Decided by testing the review's own JSON — deterministic, no model
                # call. A branch may select several arms: only the flagged roles re-run.
                ...
                {"from_key": "pm", "to_key": "engineer", "label": "code_bug",
                 "expression": "failure_type == code_bug"},
